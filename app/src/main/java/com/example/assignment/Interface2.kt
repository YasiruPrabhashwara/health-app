...
import com.example.assignment.databinding.ActivityInterface2Binding

class Interface2 : AppCompatActivity() {

    private lateinit var binding: ActivityInterface2Binding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityInterface2Binding.inflate(layoutInflater)
        enableEdgeToEdge()
